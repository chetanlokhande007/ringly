/**
 * Full ISO country list with international dialling codes.
 * Used by the dialpad country picker.
 */
export type Country = { iso: string; name: string; code: string; flag: string };
...
export const allCountries: Country[] = [
  ...
  { iso: "CI", name: "Cote d'Ivoire", code: "+225", flag: "🇨🇮" },
  { iso: "HR", name: "Croatia", code: "+385", flag: "🇭🇷" },
  { iso: "CU", name: "Cuba", code: "+53", flag: "🇨🇺" },
  { iso: "CW", name: "Curacao", code: "+599", flag: "🇨🇼" },
  ...
  { iso: "RE", name: "Reunion", code: "+262", flag: "🇷🇪" },
  ...
  { iso: "TR", name: "Turkiye", code: "+90", flag: "🇹🇷" },
...
const PINNED = ["US", "IN", "GB", "CA", "AU", "AE"];

export const countries: Country[] = [
  ...PINNED.map((i) => allCountries.find((c) => c.iso === i)!).filter(Boolean),
  ...allCountries.filter((c) => !PINNED.includes(c.iso)),
];
